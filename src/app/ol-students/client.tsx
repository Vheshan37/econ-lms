            ...
            setCards([
                {
                    icon: 'Play',
                    title: "Video Lessons",
                    description: "Watch expert video tutorials to master every concept visually.",
                    "card-color": "#ab1c1c"
                },
                {
                    icon: 'Trophy',
                    title: "Competitive Edge",
                    description: "Stay ahead of 80% of students who start late. Secure your 'A' grade foundation.",
                    "card-color": "#8b680a"
                },
                {
                    icon: 'Brain',
                    title: "Master Concepts",
                    description: "Absorb complex economic theories at your own pace without the pressure of A/L exams.",
                    "card-color": "#1e8a99"
                },
                {
                    icon: 'GraduationCap',
                    title: "University Dream",
                    description: "Early preparation is the secret weapon of every Island Ranker we've produced.",
                    "card-color": "#6c2294"
                }
            ]);
        }
