  ...
  const bottomNavigation = [
    {
      ...
      href: "/admin/contact-developer",
      icon: MessageSquare,
    },
    {
      name: "Next Improvements",
      href: "/admin/next-improvements",
      icon: Sparkles,
    },
              ...
              {mainNavigation.map((item) => {
                ...
                const LinkButton = (
                  <Link href={item.href} className="block w-full">
                    ...
                    >
                      <item.icon
                        className={`h-5 w-5 ${isActive ? "text-[#D4AF37]" : "text-gray-400 group-hover:text-white"}`}
                      />
