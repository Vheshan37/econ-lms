    ...
    <div className="space-y-8 w-full max-w-full overflow-hidden">
      <div className="mx-auto space-y-8 w-full max-w-full">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#1a1a1a] via-[#2a2a2a] to-[#1a1a1a] p-4 sm:p-8 shadow-2xl"
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6">
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <div>
                <div className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-gray-400 mb-1 sm:mb-2">
                ...
                <h1 className="text-xl sm:text-4xl font-bold text-white">Resources</h1>
