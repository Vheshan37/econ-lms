...
export default function StudentLoginPage() {
  ...
  const handleSendOTP = async (e: React.FormEvent) => {
    ...
    const result = await sendLoginOTP(email, "student");
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FAFAFA] relative overflow-hidden">
      ...
      >
        ...
        <div className="relative hidden lg:flex flex-col justify-between p-12 bg-[#1a1a1a] text-white overflow-hidden">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-25 mix-blend-overlay" />
          ...
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-gray-400 text-base max-w-md leading-relaxed">
              Log in to view online lessons, access past papers, attempt quizzes, and check your performance.
            </p>
          </div>
