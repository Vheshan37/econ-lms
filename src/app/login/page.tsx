...
import { GraduationCap, ShieldCheck, ArrowRight, Mail, Loader2 } from 'lucide-react';
                                ...
                                >
                                    ...
                                    <div className="bg-gray-50 p-1.5 rounded-xl flex relative">
                                        ...
                                        <button
                                            ...
                                            className={`flex-1 flex items-center justify-center gap-2 py-3 text-sm font-semibold rounded-lg relative z-10 transition-colors ${userType === 'student' ? 'text-[#1a1a1a]' : 'text-gray-500 hover:text-gray-700'
                                                }`}
                                        >
                                            <GraduationCap className={`w-4 h-4 ${userType === 'student' ? 'text-[#D4AF37]' : ''}`} />
                                            Student
                                        </button>
                                        <button
                                            onClick={() => setUserType('teacher')}
                                            className={`flex-1 flex items-center justify-center gap-2 py-3 text-sm font-semibold rounded-lg relative z-10 transition-colors ${userType === 'teacher' ? 'text-[#1a1a1a]' : 'text-gray-500 hover:text-gray-700'
                                                }`}
                                        >
                                            <ShieldCheck className={`w-4 h-4 ${userType === 'teacher' ? 'text-[#D4AF37]' : ''}`} />
                                            Teacher
                                        </button>
                                    </div>
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="relative group">
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder={userType === 'teacher' ? "teacher@econ.lk" : "student@example.com"}
                                                        required
