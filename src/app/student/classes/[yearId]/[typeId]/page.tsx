          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6">
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <div>
                ...
                <h1 className="text-xl sm:text-4xl font-bold text-white">Course Topics</h1>
          ...
          {topics.length > 0 ? (
            topics.map((topic: any) => (
              <Link
                ...
                className="group bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 hover:shadow-lg hover:border-[#D4AF37]/30 transition-all cursor-pointer relative overflow-hidden block"
              >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <h3 className="text-lg sm:text-xl font-bold mb-1 transition-colors text-gray-900 group-hover:text-[#D4AF37]">
                      {topic.title}
                    </h3>
                    {topic.description && (
            ...
            <div className="text-center py-16 bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200">
              ...
              <p className="text-gray-400 text-sm mt-2">
                This class type doesn&apos;t have any topics yet
              </p>
            </div>
          )}
        </div>
