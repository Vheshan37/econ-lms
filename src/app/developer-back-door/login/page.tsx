        ...
        <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4">
            <div className="max-w-md w-full">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-bold text-white mb-2 font-serif tracking-tight">Security Gateway</h1>
                        ...
                        {step === 1 ? (
                            <form onSubmit={handleStep1Submit} className="space-y-6">
                                <div className="space-y-2">
                                    <Label className="text-gray-300 ml-1">Terminal ID (Email)</Label>
                                ...
                                <div className="space-y-2">
                                    <Label className="text-gray-300 ml-1">Access Key (Password)</Label>
                                    <div className="relative">
                                ...
                                >
                                    {isLoading ? <Loader2 className="w-6 h-6 animate-spin" /> : (
                                        <>Request Authorization <ArrowRight className="ml-2 w-5 h-5 text-[#050505]" /></>
                                    )}
                                </Button>
                            </form>
                        ) : (
                            <form onSubmit={handleStep2Submit} className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                                <div className="text-center mb-6">
                                    <p className="text-gray-400 text-sm">A multi-factor authentication code was sent to your secure terminal.</p>
                                </div>

                                <div className="space-y-2 text-center">
                                    <Label className="text-gray-300">Verification Code (OTP)</Label>
                                    <Input
                                        type="text"
                                        value={otp}
