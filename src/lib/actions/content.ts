...
export async function updateAllLandingPageContent(data: { [key: string]: any }) {
    try {
...
export async function createTestimonial(data: { name: string; role: string; content: string; imageUrl?: string; rating?: number; institute?: string }) {
    try {
...
export async function updateTestimonial(id: string, data: { name?: string; role?: string; content?: string; imageUrl?: string; rating?: number; institute?: string; isActive?: boolean }) {
    try {
...
export async function createModernFeature(data: { title: string; description: string; icon: string; color?: string; order?: number }) {
    try {
...
export async function updateModernFeature(id: string, data: { title?: string; description?: string; icon?: string; color?: string; order?: number; isActive?: boolean }) {
    try {
...
export async function createCourse(data: { year: string; title: string; status: string; description: string; schedule: string; color: string; order?: number }) {
    try {
...
export async function updateCourse(id: string, data: { year?: string; title?: string; status?: string; description?: string; schedule?: string; color?: string; order?: number; isActive?: boolean }) {
    try {
...
export async function createInstitute(data: { name: string; location: string }) {
    try {
...
export async function updateInstitute(id: string, data: { name?: string; location?: string }) {
    try {
...
export async function createTimetable(data: { instituteId: string; day: string; startTime: string; endTime: string; academicYear: string }) {
    try {
...
export async function createFreeResource(data: { title: string; type: 'VIDEO' | 'PDF' | 'PAST_PAPER' | 'QUIZ'; url: string; description?: string }) {
    try {
...
export async function updateFreeResource(id: string, data: { title?: string; type?: 'VIDEO' | 'PDF' | 'PAST_PAPER' | 'QUIZ'; url?: string; description?: string }) {
    try {
