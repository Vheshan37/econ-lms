            ...
            <div className="container mx-auto px-4 z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center pt-20">
                ...
                >
                    ...
                    <p className="text-lg text-gray-400 max-w-xl leading-relaxed">
                        {data.description || "දිවයිනේ ප්‍රථම ශ්‍රේණිගත කරුවන් බිහිකරන ලද ඔප්පු වූ ඉතිහාසයක් ඇති වඩාත්ම සවිස්තරාත්මක ආර්ථික විද්‍යා අධ්‍යාපනය අත්විඳින්න. විශිෂ්ටත්වයේ සම්මේලනයට එක්වන්න."}
                    </p>
                    ...
                    <div className="flex items-center gap-8 pt-8 border-t border-gray-800">
                        <div>
                            <p className="text-3xl font-bold text-white">{data.studentCount || "5000+"}</p>
                            <p className="text-sm text-gray-500 uppercase tracking-wider">Students</p>
                        </div>
                        <div>
                            <p className="text-3xl font-bold text-white">{data.rankCount || "100+"}</p>
                            <p className="text-sm text-gray-500 uppercase tracking-wider">Island Ranks</p>
                        </div>
                        <div>
                            <p className="text-3xl font-bold text-white">{data.expCount || "10+"}</p>
                    ...
                    <div className="relative z-10 w-full max-w-md mx-auto">
                        <div className="aspect-[3/4] rounded-3xl overflow-hidden bg-gradient-to-b from-gray-800 to-black border border-gray-800 relative group">
                            <div
                                ...
                                style={{ backgroundImage: `url(${data.teacherImage || 'https://placehold.co/600x800/1a1a1a/FFF?text=Teacher+Image'})` }}
                            />
