        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button
              variant="outline"
              size="lg"
              className="h-14 px-8 text-lg border-gray-700/50 bg-gray-900/50 text-gray-300 hover:border-[#fdf021] hover:bg-[#fdf021]/10 hover:text-[#fdf021] rounded-full w-full sm:w-auto transition-all duration-300"
            >
          ...
          <div className="relative z-10 w-full max-w-md mx-auto">
            <div className="aspect-[3/4] rounded-3xl overflow-hidden bg-gradient-to-b from-gray-800 to-black border border-gray-800 relative group">
              <div
                ...
                style={{
                  backgroundImage: `url(${data.teacherImage || "https://placehold.co/600x800/1a1a1a/FFF?text=Teacher+Image"})`,
                }}
              />
              ...
              <div className="absolute bottom-8 left-8 right-8">
                <div className="bg-white/10 backdrop-blur-md p-4 rounded-xl border border-white/10">
                  <p className="text-[#fdf021] font-bold text-lg">
                    {data.teacherName || "Krishan Kashthuriarachchi"}
                  </p>
                  <p className="text-gray-300 text-sm">
                    {data.teacherTitle ||
                      "B.Sc. Economics (Sp.) University of Colombo"}
                  </p>
                </div>
              </div>
            </div>
