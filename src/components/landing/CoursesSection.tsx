    ...
    const colors = [
      {
        ...
        border: "border-[#fdf021]/20",
        dot: "bg-yellow-400",
        btnHover: "hover:bg-[#fdf021]",
      },
      {
          ...
          <div className="bg-[#111] rounded-2xl border border-gray-800 overflow-hidden">
                  ...
                  <div key={year.id}>
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div
                          className={`w-1.5 h-12 rounded-full ${colors.bar}`}
                        />
                        <div>
                          ...
                          <p
                            className={`${colors.text} text-xs font-medium uppercase tracking-wider`}
                          >
                            Advanced Level
                          </p>
                        </div>
            ...
            <div className="p-4 bg-[#fdf021]/5 border-t border-[#fdf021]/10">
              <p className="text-xs text-gray-500 text-center">
                💡 All classes include comprehensive study materials and past
                paper discussions
              </p>
            </div>
          </div>
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {years.map((year, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`h-2 bg-gradient-to-r ${colors.gradient} flex-shrink-0`}
                />
                  ...
                  <div className="space-y-5 flex-1">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p
                          className={`${colors.text} text-sm font-medium uppercase tracking-wider mt-1`}
                        >
                          Advanced Level
                        </p>
                      </div>
                    ...
                    <div className="space-y-3">
                      {classNames.length > 0 ? (
                        ...
                        <div
                          className={`px-4 py-3 rounded-xl ${colors.bg} ${colors.border} border`}
                        >
        ...
        {years.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 text-sm mt-2">
              New batches will be announced soon. Stay tuned!
            </p>
          </div>
        )}
      </div>
