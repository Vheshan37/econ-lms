...
export function CoursesSection({ years, whatsappNumber }: CoursesSectionProps) {
  ...
  return (
    <section id="courses" className="bg-[#050505] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {years.map((year, index) => {
            ...
            return (
              <div
                key={year.id}
                className="group relative bg-[#111] rounded-2xl overflow-hidden border border-gray-800 hover:border-yellow-500/50 transition-colors duration-300"
              >
                {/* Gradient Header */}
                ...
                <div className="p-8 space-y-6">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-yellow-500 text-sm font-medium uppercase tracking-wider mt-1">
                        Advanced Level
                      </p>
                    </div>
