...
const LocationMap = dynamic(
    ...
    })),
  {
    ssr: false,
    loading: () => (
      <div className="w-full h-[400px] bg-gray-900 rounded-2xl animate-pulse" />
    ),
  },
);
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            ප්‍රශ්න තිබේද? ලියාපදිංචි වීමට අවශ්‍යද? අප සමඟ සම්බන්ධ වී ඔබගේ
            ශාස්ත්‍රීය ඉලක්ක කරා පළමු පියවර තබන්න.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
                ...
                <div>
                  ...
                  >
                    ...
                    {contactContent.locations?.map((loc: any, idx: number) => (
                      <option key={idx} value={loc.name.toLowerCase()}>
                        {loc.name}
                      </option>
                    ))}
          ...
          <div className="space-y-8">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-gray-400 hover:text-[#fdf021] transition-colors"
                      >
                        {contactContent.phone}
                      </a>
                    </div>
                ...
                <div className="bg-gradient-to-br from-gray-900 to-gray-950 rounded-2xl p-6 border border-gray-800 hover:border-[#fdf021]/50 transition-all duration-300 group">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">{contactContent.address}</p>
                    </div>
                  </div>
                </div>
              )}
            ...
            {contactContent.locations &&
              contactContent.locations.some(
                ...
                <div className="bg-gradient-to-br from-gray-900 to-gray-950 rounded-2xl p-2 border border-gray-800 overflow-hidden">
                  <h4 className="text-white font-semibold px-4 pt-4 pb-2">
                    📍 Institute Locations
                  </h4>
          ...
          <div className="grid md:grid-cols-2 gap-4 text-center">
            <div>
              ...
              <p className="text-white font-semibold">
                {contactContent.officeHours?.weekdays || "9:00 AM - 6:00 PM"}
              </p>
            </div>
            <div>
              <p className="text-gray-400 text-sm">Weekends</p>
              <p className="text-white font-semibold">
                {contactContent.officeHours?.weekends || "9:00 AM - 3:00 PM"}
              </p>
            </div>
          </div>
        </div>
