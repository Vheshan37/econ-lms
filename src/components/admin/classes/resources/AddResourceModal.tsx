...
import { X, Plus, Youtube, FileText, File, ClipboardList, ChevronRight, Calendar, Check, ChevronDown } from 'lucide-react';
...
export function AddResourceModal({ isOpen, onClose, topicId, onSuccess }: AddResourceModalProps) {
    ...
    const selectedMonthName = selectedMonth !== null ? MONTHS[selectedMonth] : null;
                                                ...
                                                {TABS.map((tab) => {
                                                    ...
                                                    return (
                                                        <button
                                                            key={tab.id}
                                                            type="button"
                                                            onClick={() => setSelectedType(tab.id as ResourceType)}
                                    ...
                                    >
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {selectedYear === currentYear && (
                                                <p className="text-xs text-[#D4AF37] ml-1">Current academic year</p>
                                            )}
                                        </div>
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                {selectedMonthName ? (
                                                    <p className="text-sm text-gray-300">
                                                        Selected: <span className="text-[#D4AF37] font-bold">{selectedMonthName}</span>
                                                    </p>
                                                ) : (
                                                    <p className="text-sm text-gray-500">No month selected</p>
                                                )}
                                            </div>
                                        </div>
